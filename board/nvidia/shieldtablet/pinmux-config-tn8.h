 ...
 * Run "board-to-uboot.py tn8".
 */

#ifndef _PINMUX_CONFIG_TN8_H_
#define _PINMUX_CONFIG_TN8_H_
...
static const struct tegra_gpio_config tn8_gpio_inits[] = {
        /*        port, pin, init_val */
        GPIO_INIT(C,    7,   IN),
        GPIO_INIT(H,    2,   OUT1),
        GPIO_INIT(H,    3,   OUT0),
...
// WARNING: Unconfigured pin gmi_clk_lb
static const struct pmux_pingrp_config tn8_pingrps[] = {
        ...
        PINCFG(PG2,                    RSVD4,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PG3,                    RSVD4,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PG4,                    RSVD1,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PG5,                    RSVD1,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PG6,                    RSVD1,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PG7,                    RSVD1,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(PI1,                    RSVD1,       NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        ...
        PINCFG(PI5,                    GMI,         DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(PK2,                    RSVD4,       NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(PK3,                    GMI,         DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(PK4,                    GMI,         NORMAL, NORMAL,   OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(SPDIF_OUT_PK5,          RSVD3,       NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        ...
        PINCFG(USB_VBUS_EN0_PN4,       USB,         NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
        PINCFG(USB_VBUS_EN1_PN5,       USB,         NORMAL, NORMAL,   OUTPUT,  DISABLE, DEFAULT),
        ...
        PINCFG(ULPI_DATA1_PO2,         SPI3,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(ULPI_DATA2_PO3,         SPI3,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(ULPI_DATA3_PO4,         SPI3,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(ULPI_DATA4_PO5,         SPI2,        UP,     NORMAL,   INPUT,   DEFAULT, DEFAULT),
        ...
        PINCFG(DAP4_FS_PP4,            I2S3,        NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(DAP4_DIN_PP5,           I2S3,        NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(DAP4_DOUT_PP6,          I2S3,        NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(DAP4_SCLK_PP7,          I2S3,        NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        ...
        PINCFG(KB_ROW10_PS2,           KBC,         DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(KB_ROW13_PS5,           RSVD4,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(KB_ROW14_PS6,           RSVD4,       DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(PU4,                    PWM1,        DOWN,   TRISTATE, INPUT,   DEFAULT, DEFAULT),
        PINCFG(PU5,                    PWM2,        NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(PU6,                    RSVD3,       NORMAL, NORMAL,   INPUT,   DEFAULT, DEFAULT),
        ...
        PINCFG(CLK2_OUT_PW5,           EXTPERIPH2,  DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(UART3_TXD_PW6,          UARTC,       UP,     NORMAL,   OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(UART3_RXD_PW7,          UARTC,       UP,     NORMAL,   INPUT,   DEFAULT, DEFAULT),
        PINCFG(DVFS_PWM_PX0,           SPI6,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(GPIO_X1_AUD_PX1,        SPI6,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        PINCFG(DVFS_CLK_PX2,           SPI6,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(GPIO_X5_AUD_PX5,        SPI1,        DOWN,   TRISTATE, OUTPUT,  DEFAULT, DEFAULT),
        ...
        PINCFG(USB_VBUS_EN2_PFF1,      USB,         DOWN,   TRISTATE, OUTPUT,  DISABLE, DEFAULT),
...
static const struct pmux_drvgrp_config tn8_drvgrps[] = {
};

#endif /* PINMUX_CONFIG_TN8_H */
